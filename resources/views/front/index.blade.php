...
<nav id="Category" class="max-w-[1130px] mx-auto flex justify-center items-center gap-4 mt-[30px]">
    ...
    <a href="{{route('front.category' , $category->slug)}}" class="rounded-full p-[12px_22px] flex gap-[10px] font-semibold transition-all duration-300 border border-[#EEF0F7] hover:ring-2 hover:ring-[#FF6B18]" style="color: rgb(73, 49, 4);">
    ...
    @endforeach
                ...
                <div class="featured-news-card relative w-full h-[550px] flex shrink-0 overflow-hidden">
					...
					<div class="card-detail max-w-[1130px] w-full mx-auto flex items-end justify-between pb-10 relative z-20">
						<div class="flex flex-col gap-[10px]">
							...
							<a href="details.html" class="font-bold text-4xl leading-[45px] text-white two-lines hover:underline transition-all duration-300">{{$post->judul}}</a>
        ...
        <footer class="py-6 text-sm text-center text-gray-500 dark:text-gray-400">
            &copy; {{ date('Y') }} wowfarhan3@gmail.com. <footer style="color: rgb(73, 49, 4); All rights reserved.
        </footer>
	</body>
</html>
